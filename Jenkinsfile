        ...
        stage('Database Dump') {
            steps {
                script {
                    ...
                    sh " gcloud compute ssh ${instanceName} --project=${gcpProject} --zone=${gcpZone} --command='mysqldump -u root@localhost –p Password@123 karthik  Employee > dumpfilename.sql' "
